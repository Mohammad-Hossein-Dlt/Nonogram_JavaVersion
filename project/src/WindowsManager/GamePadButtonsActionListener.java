...
public class GamePadButtonsActionListener {
    public static void restart(JFrame mainWindow){
        ...
        DataManager.restart();
        MainWindow.reload(mainWindow, new Game(Integer.parseInt(ReedData.GameConfig.get(0)), Double.parseDouble(ReedData.GameConfig.get(1)), MainWindow.moreEasy, false));
    }
    public static void tryAgain(JFrame mainWindow){
        ...
        ReedData.Reed();
        MainWindow.reload(mainWindow, new Game(Integer.parseInt(ReedData.GameConfig.get(0)), Double.parseDouble(ReedData.GameConfig.get(1)), MainWindow.moreEasy, true));
