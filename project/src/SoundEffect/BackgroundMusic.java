...
//        Because When Start Button Clicked No Data Is Read And ReedData.GameConfig.get(3) Gives Error
//        But When It Placed After || Only continueGame Is Checked
        if (SettingsData.Music.equals("On") && ( !continueGame || ReedData.GameConfig.get(3).equals("Unfinished") ) ) {
            try {
